...
Function Get-AvmBuildPublishSet
{
  ...
  $ToPublish = Get-ChildItem -Path $AvmPackageBuildRoot -Recurse -Depth 1 -Directory | Where-Object { $_.Name -match "\d+\.\d+\.\d+" } | ForEach-Object {
    $ToPublishRoot = $_
...
Function Send-MicrosoftTeamsChannelMessage
{
  ...
  Function Send-TeamChannelMessage
  {
    ...
    Switch ($messageType)
    {
      "Information" { $TitleColor = "Accent";    $Image = $imgInformation }
      "Success"     { $TitleColor = "Good";      $Image = $imgSuccess }
      "Warning"     { $TitleColor = "Warning";   $Image = $imgWarning }
      "Critical"    { $TitleColor = "Attention"; $Image = $imgCritical }
    }
    ...
    if ($activityTitle -or $activitySubtitle) {
      $activityItems = @()
