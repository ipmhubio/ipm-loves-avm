...
Function Set-AvmBicepPublishState
{
  ...
  Process
  {
    ...
    Else
    {
      $Response = Invoke-RestMethod -Uri ("{0}{1}(PartitionKey='{2}',RowKey='{3}'){4}" -f $BaseUri, $StateTableName, $Variant, $Record.RowKey, $SasToken) -Method "Merge" -Headers $Headers -Body $Record
    }
